...
public class Servidor {
	...
	public void listen() {
		...
		try {
			...
			serverSocket = (SSLServerSocket) servFactory.createServerSocket(PORT, 10);
	...
	public static void proccesClientRequest(Socket clientSocket) {
	...
	public static boolean isFirewallMessage(String clientMessage) {
	...
	public static String processData(String clientMessage) {
